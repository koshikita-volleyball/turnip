...
import { MovingAverageType, OHCL, ScreeningConditionCrossOverStruct, ScreeningConditionGrowthRateStruct, ScreeningConditionStructs } from '../interface/screening_condition';
...
export default function ScreeningConditionModal(props: {
  ...
  const [selectedCondition, setSelectedCondition] = useState<ScreeningConditionStructs | null>(null)
                ...
                {(() => {
                  ...
                  return <>
                    ...
                    <Form.Group className="mt-3">
                      ...
                      <Form.Control type="number" value={condition.threshold} step={0.1} onChange={(e) => {
                        setSelectedCondition({
                          ...selectedCondition,
                    ...
                    <Form.Group className="mt-3">
                      ...
                      <Form.Group className="d-flex justify-content-between align-items-center">
                        <Form.Control type='date' value={condition.before} onChange={(e) => {
                          setSelectedCondition({
                            ...selectedCondition,
                        ...
                        ～
                        <Form.Control type='date' value={condition.after} onChange={(e) => {
                          setSelectedCondition({
                            ...selectedCondition,
